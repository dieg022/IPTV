                ...
                <div class="x_content">
                    <table id="datatable2" class="table table-striped table-bordered">
                        ...
                        <tr>
                            <td>
                                <?php
                                    $user = App\User::find($obj->user_id);
                            ...
                            ?>
                            <td>{{ $snMac }}</td>
                            <td style="text-align:center;"><a href='{{ URL::to("rma/$obj->id/edit") }}' class="btn btn-default"><i class="fa fa-edit"></i></a></td>
