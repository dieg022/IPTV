...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal"  action="{{ URL::to('background/'.$background->id)}}" method="post" novalidate  enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="background">Fondo</label>
                        <div class="col-sm-5">
                            <input id="background" class="form-control" type="text" placeholder="Nombre Fondo" name="background" value="{{ old('background',$background->background) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="hidden" id="urlbackground_original"  name="urlbackground_original" value="{{ old('urlbackground',$background->urlbackground) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="urlbackground">Seleccione nueva Imagen</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-md-2"
                             data-form="#borrarclienteformulario" data-title="Eliminar Fondo" data-message="¿Desea eliminar el este fondo?<br><BR> <B>IMPORTANTE</B>:Si estuviese seleccionado
por un perfil de instalación, éste también será eliminado">
                        ...
                        <div class="col-md-2"> <a href="{{ url('background')}}" class="btn btn-default">Cancelar</a></div>
                ...
                <form id="borrarclienteformulario" name=borrarclienteformulario" action="{{ URL::to('background/'.$background->id)}}" method="post" novalidate>
