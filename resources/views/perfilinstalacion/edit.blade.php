...
<div class="page-title">
    <div class="title_left">
        <h3>Editar Perfil Instalación</h3>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal"  action="{{ URL::to('perfilinstalacion/'.$perfilinstalacion->id)}}" method="post" novalidate>

                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="nombre">Nombre Perfil</label>
                        <div class="col-sm-5">
                            <input id="nombre" class="form-control" type="text" placeholder="Nombre Perfil" name="nombre" value="{{ old('nombre',$perfilinstalacion->nombre) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="paquetecanal_id" class="form-control" name="paquetecanal_id" value="{{ old('paquetecanal_id',$perfilinstalacion->paquetecanal_id) }}">
                                <option value=""></option>
                                @foreach($paquetescanales as $pack)


                                @if (old('paquetecanal_id',$perfilinstalacion->paquetecanal_id) == $pack->id)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="background_id" class="form-control" name="background_id" value="{{ old('background_id',$perfilinstalacion->background_id) }}">
                                <option value=""></option>
                                @foreach($backgrounds as $bg)


                                @if (old('background_id',$perfilinstalacion->background_id) == $bg->id)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            @if (old('wifienabled',$perfilinstalacion->wifienabled) == 1)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="ssid" class="form-control" type="text" placeholder="SSID" name="ssid" value="{{ old('ssid',$perfilinstalacion->ssid) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="password" class="form-control" type="text" placeholder="Password Wifi" name="password" value="{{ old('password',$perfilinstalacion->password) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="wificanal" class="form-control" name="wificanal" value="{{ old('wificanal',$perfilinstalacion->wificanal) }}">
                                <option value=""></option>

                                @for ($i = 1; $i < 14; $i++)
                                @if (old('wificanal',$perfilinstalacion->wificanal) == "$i")
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-md-2" data-form="#borrarclienteformulario" data-title="Eliminar Perfil de instalacion" data-message="¿Desea eliminar el este perfil de instalacion?">
                            <a class = "formConfirm btn btn-danger" href="" class="btn btn-danger">Eliminar</a>
                        </div>
                        <div class="col-md-2"> <a href="{{ url('perfilinstalacion')}}" class="btn btn-default">Cancelar</a></div>
                ...
                <form id="borrarclienteformulario" name=borrarclienteformulario" action="{{ URL::to('perfilinstalacion/'.$perfilinstalacion->id)}}" method="post" novalidate>
...
<script>
    $(document).ready(function() {
        ...
        //estado inicial
        //alert($('#wifienabled').val($(this).is(':checked')));
