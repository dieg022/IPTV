...
<div class="page-title">
    <div class="title_left">
        <h3>Editar IPTV para {{$cliente->cif}}</h3>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal" action='{{ URL::to("cliente/$cliente->id/iptv/$iptv->id/modificar") }}' method="post" novalidate>



                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="perfilinstalacion_id">Seleccione un perfil de instalación (para sobreescribir)</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="paquetecanal_id" class="form-control" name="paquetecanal_id" value="{{ $paquetecanal_id }}">
                                <option value=""></option>
                                @foreach($paquetescanales as $pack)


                                @if ($paquetecanal_id == $pack->id)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="background_id" class="form-control" name="background_id" value="{{$background_id}}">
                                <option value=""></option>
                                @foreach($backgrounds as $bg)
                                    @if ($background_id == $bg->id)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="ssid" class="form-control" type="text" placeholder="SSID" name="ssid" value="{{ $ssid }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="password" class="form-control" type="text" placeholder="Password Wifi" name="password" value="{{ $password }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="wificanal" class="form-control" name="wificanal" value="{{$wificanal}}">
                                <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="switchpoe_id" class="form-control" name="switchpoe_id" value="{{ $switchpoe_id }}">
                                <option value=""></option>
                                @foreach($switchs as $bg)


                                @if ($switchpoe_id == $bg->id)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="puerto" class="form-control" name="puerto" value="{{ $puerto }}">
                                <option value=""></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="observaciones" class="form-control" type="text" placeholder="Observaciones" name="observaciones" value="{{ $observaciones }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-2 col-md-4"><button style="align:right;" type="submit" class="btn btn-primary">Editar</button> </div>
                    </div>
