            ...
            <div class="x_content">
                ...
                <form id="main" name="main" class="form-horizontal" action="{{ URL::to('cliente')}}" method="post" novalidate>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="cif">Número Habitación</label>
                        <div class="col-sm-5">
                            <input id="cif" class="form-control" type="text" placeholder="Numero habitación" name="cif" value="{{ old('cif') }}">
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-md-2"> <a href="{{ url('cliente')}}" class="btn btn-danger">Cancelar</a></div>
