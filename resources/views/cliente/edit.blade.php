            ...
            <div class="x_content">
                ...
                <form id="main" name="main" class="form-horizontal"  action="{{ URL::to('cliente/'.$cliente->id)}}" method="post" novalidate>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="cif" class="form-control" type="text" placeholder="DNI/CIF" name="cif" value="{{ old('cif',$cliente->cif) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="nombrecompleto">Nombre Completo</label>
                        <div class="col-sm-5">
                            <input id="nombrecompleto" class="form-control" type="text" placeholder="Nombre Completo" name="nombrecompleto" value="{{ old('nombrecompleto',$cliente->nombrecompleto) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="direccion" class="form-control" type="text" placeholder="Direccion" name="direccion" value="{{ old('direccion',$cliente->direccion) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="poblacion" class="form-control" type="text" placeholder="Poblacion" name="poblacion" value="{{ old('poblacion',$cliente->poblacion) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class=" col-sm-offset-2 col-sm-5">
                            <div class="col-sm-3" style="text-align: left;padding-left:0"
                                 data-form="#borrarclienteformulario" data-title="Eliminar Cliente" data-message="¿Desea eliminar el este cliente?">
                                <a class = "formConfirm btn btn-danger" href="" class="btn btn-danger">Eliminar</a>
                            </div>
                            <div class="col-sm-6" style="margin-left:auto;margin-right: auto;display:block;text-align:center;"> <a href="{{ url('cliente')}}" class="btn btn-default">Cancelar</a></div>
                            <div class="col-sm-3" style="text-align: right; padding-right:0;"><button style="align:right;" type="submit" class="btn btn-primary">Editar</button> </div>
