...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3>Iptvs Asociados para {{$cliente->cif}}</h3>
        </div>
            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <a href='{{ URL::to("cliente/$cliente->id/asociar") }}' class="btn btn-default"><i class="fa fa-plus" style="margin-right: 5px"></i>Asociar IPTV</a>
                    </ul>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="x_content">
                    <table id="datatable2" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{ $iptv->mac }}</td>
                            <td>{{ $iptv->tipo }}</td>
                            <td>{{ $iptv->pivot->ipactual }}</td>
                            <td>{{ $iptv->pivot->observaciones }}</td>
                            <td style="text-align:center;"><a href='{{ URL::to("cliente/$cliente->id/iptv/$iptv->id/editar") }}' class="btn btn-default"><i class="fa fa-edit"></i></a></td>
                            <!--<td style="text-align:center;"><a href='{{ URL::to("cliente/$cliente->id/iptv/$iptv->id/default") }}' class="btn btn-default"><i class="fa fa-refresh"></i></a></td>-->
                            <td style="text-align:center;"><a href='{{ URL::to("cliente/$cliente->id/iptv/$iptv->id/reemplazar") }}' class="btn btn-default"><i class="fa fa-exchange"></i></a></td>
                            <td style="text-align:center;"><a href='{{ URL::to("cliente/$cliente->id/iptv/$iptv->id/retirar") }}' class="btn btn-default"><i class="fa fa-close"></i></a></td>
