...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal" action="{{ URL::to('cliente')}}" method="post" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="nombrecompleto" class="form-control" type="text" placeholder="Nombre Completo" name="nombrecompleto" value="{{ old('nombrecompleto') }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="float: left"> <a href="{{ url('cliente')}}" class="btn btn-danger">Cancelar</a></div>
                        <div style="float: right"><button style="align:right;" type="submit" class="btn btn-primary">Crear</button> </div>
                        </div>
                    </div>
