...
<div class="page-title">
    <div class="title_left">
        <h3>Asociando IPTV a {{$cliente->cif}}</h3>
    </div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal" action='{{ URL::to("cliente/$cliente->id/asociar")}}' method="post" novalidate>


                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="iptv_id">
                            Seleccione un iptv de los disponibles
                        </label>
                        <div class="col-sm-5">
                            <select id="iptv_id" class="form-control" name="iptv_id" value="{{ old('iptv_id') }}">

                                <option value=""></option>
                                @foreach($iptvs as $iptv)
                                @if (old('iptv_id') == $iptv->id)
                                <option value="{{ $iptv->id }}" selected >{{ $iptv->numeroserie }} ( {{ $iptv->mac }} )</option>
                                @else
