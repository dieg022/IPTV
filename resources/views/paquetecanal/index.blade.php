            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <a href="{{ URL::to('paquetecanal/create') }}" class="btn btn-default"><i class="fa fa-plus" style="margin-right: 5px"></i>Crear Paquete</a>
                    </ul>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="x_content">
                    <table id="datatable2" class="table table-striped table-bordered">
                        ...
                        @foreach($objs as $obj)
                        <tr>
                            <td>{{ $obj->nombrepaquete }}</td>
                            <td style="text-align:center;"><a href='{{ URL::to("paquetecanal/$obj->id/edit") }}' class="btn btn-default"><i class="fa fa-edit"></i></a></td>
                        </tr>
                        @endforeach
