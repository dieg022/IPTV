...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal"  action="{{ URL::to('switchpoe/'.$switchpoe->id)}}" method="post" novalidate>

                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="nombre">Nombre Switch</label>
                        <div class="col-sm-5">
                            <input id="nombre" class="form-control" type="text" placeholder="Identificacion Switch" name="nombre" value="{{ old('nombre',$switchpoe->nombre) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="ubicacion" class="form-control" type="text" placeholder="Ubicacion" name="ubicacion" value="{{ old('ubicacion',$switchpoe->ubicacion) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="direccionip" class="form-control" type="text" placeholder="Direccion IP" name="direccionip" data-inputmask="'mask' : '***.***.***.***'"
                                   value="{{ old('direccionip',$switchpoe->direccionip) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="user_acceso" class="form-control" type="text" placeholder="Usuario acceso a switch" name="user_acceso" value="{{ old('user_acceso',$switchpoe->user_acceso) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="pass_acceso" class="form-control" type="password" placeholder="Password acceso a switch" name="pass_acceso" value="*****">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="confirm-password" class="form-control" type="password" placeholder="Confirme password" name="confirm-password" value="*****" >
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-md-2"
                             data-form="#borrarclienteformulario" data-title="Eliminar Switch Poe" data-message="¿Desea eliminar el este switch?">
                            <a class = "formConfirm btn btn-danger" href="" class="btn btn-danger">Eliminar</a>
                        </div>
                        <div class="col-md-2"> <a href="{{ url('switchpoe')}}" class="btn btn-default">Cancelar</a></div>
                ...
                <form id="borrarclienteformulario" name=borrarclienteformulario" action="{{ URL::to('switchpoe/'.$switchpoe->id)}}" method="post" novalidate>
