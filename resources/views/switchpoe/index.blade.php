            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <a href="{{ URL::to('switchpoe/create') }}" class="btn btn-default"><i class="fa fa-plus" style="margin-right: 5px"></i>Añadir Switch</a>
                    </ul>
                    <div class="clearfix"></div>
                </div>
                ...
                <div class="x_content">
                    <table id="datatable2" class="table table-striped table-bordered">
                        ...
                        <tr>
                            <td>{{ $obj->nombre }}</td>
                            <td>{{ $obj->ubicacion }}</td>
                            <td>{{ $obj->direccionip }}</td>
                            <td style="text-align:center;"><a href='{{ URL::to("switchpoe/$obj->id/edit") }}' class="btn btn-default"><i class="fa fa-edit"></i></a></td>
                        </tr>
                        @endforeach
