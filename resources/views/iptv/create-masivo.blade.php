        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form id="main" name="main" class="form-horizontal" action="{{ URL::to('iptv')}}" method="post" novalidate>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">MACs</label>
                        <div class="col-sm-5">
                            <textarea name="mac" id="mac" rows="10" style="width: 100%">{{ old('mac') }}</textarea>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Numeros de Serie</label>
                        <div class="col-sm-5">
                            <textarea name="numeroserie" rows="10" style="width: 100%">{{ old('numeroserie') }}</textarea>
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="hidden" id="masiva" name="masiva" value="true">
                        </div>
                        <!-- como kite esto se va a la picha-->
                        <div class="col-sm-5 messages">
                        </div>
