                ...
                <div class="x_content">
                    <table id="datatable2" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <th>MAC</th>
                            <th>Modelo</th>
                            <th>{{ $usuario->tipoClienteDestino() }}</th>
                            <th>Editar</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $iptv->mac }}</td>
                            <td>{{ $iptv->tipo }}</td>
                            <td>{{ $iptv->getCliente()->cif }}</td>
                            <?php
                                $id=$iptv->getCliente()->id;
                            ?>
                            <td style="text-align:center;"><a href='{{ URL::to("cliente/$id/iptvs") }}' class="btn btn-default"><i class="fa fa-edit"></i></a></td>
                        </tr>
                        @endforeach
                        </tbody>
