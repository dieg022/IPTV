...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal" action="{{ URL::to('iptv/'.$iptv->id )}}" method="post" novalidate>

                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="tipo">Fecha Compra</label>
                        <div class="col-sm-5">
                            <div class='input-group date' id='myDatepicker2'>
                                <input type='text' id="fechacompra" name="fechacompra" class="form-control" value="{{ old('fechacompra',$iptv->fechacompra) }}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="proveedor_id" class="form-control" name="proveedor_id" value="{{ old('proveedor_id',$iptv->proveedor_id) }}">
                                <option value=""></option>
                                @foreach($proveedores as $proveedor)


                                @if (old('proveedor_id',$iptv->proveedor_id) == $proveedor->id)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="numeroserie" class="form-control" type="text" placeholder="Numero Serie" name="numeroserie" value="{{ old('numeroserie',$iptv->numeroserie) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select id="usuario_id" class="form-control" name="usuario_id" value="{{ old('usuario_id',$iptv->getUsuario()->id) }}">

                                <option value="-1">Sin Asignar</option>
                                @foreach($usuarios as $usuario)
                                @if (old('usuario_id',$iptv->getUsuario()->id) == $usuario->id )
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-2 col-md-4"><button style="align:right;" type="submit" class="btn btn-primary">Modificar</button> </div>
                    </div>
