...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="main" name="main" class="form-horizontal" action="{{ URL::to('proveedor/'.$proveedor->id )}}" method="post" novalidate>

                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="proveedor">Proveedor</label>
                        <div class="col-sm-5">
                            <input id="proveedor" class="form-control" type="text" placeholder="Nombre Proveedor" name="proveedor" value="{{ old('proveedor',$proveedor->proveedor) }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="telefono" class="form-control" type="text" placeholder="Telefono" name="telefono" value="{{ old('telefono',$proveedor->telefono) }}">
                        </div>
                        <div class="col-sm-5 messages">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input id="email" class="form-control" type="email" placeholder="Email" name="email" value="{{ old('email',$proveedor->email) }}">
                        </div>
